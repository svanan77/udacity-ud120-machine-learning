...
def poiFlagEmail(f):
    ...
    print "to_emails",to_emails, "cc_emails",cc_emails,"from_emails",from_emails,"poi_email_list=",poi_email_list
    
    #to_emails ['james.bannantine@enron.com', 'cliff.baxter@enron.com' 'brenda.castillo@enron.com'] 
    #cc_emails None 
    #from_emails ['katherine.brown@enron.com'] 
    ...
    #code would not execute as import reader and poi_emails is not available
    #################################
